...
public class PostItem extends AppCompatActivity {
    ...
    EditText name,price,description,mobile;
    ImageView item_pic;
    ...
    public void uploadPic(String ItemName,String descriptionStr, String priceStr, String mobilePhone){
        if(uriImage != null){
            Random r = new Random();
            int i1 = r.nextInt(4500 - 28) + 28;
            int i2 = r.nextInt(45 - 28) + 28;
            StorageReference fileReference = storageReference.child(firebaseUser.getUid()+i1+i2+"."+getFileExtension(uriImage));
...
//                            Log.i("url img",image_url[0]);
                            ...
                            ReadWriteItemDetails itemDetailsObject = new ReadWriteItemDetails(ItemName, descriptionStr, priceStr, image_url[0],mobilePhone,date);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    uploadPic(ItemName,descriptionStr,priceStr, mobileNumber);
                }
                catch (Exception e){
